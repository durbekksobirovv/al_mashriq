  ...
  return (
    <div className="relative space-y-10 pb-20 w-full px-2 md:px-6">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-red-500/5 blur-[120px] rounded-full" />
            ...
            <div className="flex items-end gap-2 h-32 mb-6">
              {[...Array(8)].map((_, i) => (
                <motion.div
                  ...
                  className="w-3 bg-red-500 rounded-full shadow-[0_0_20px_#10b981]"
                />
              ))}
            </div>
            <p className="text-red-500 font-black tracking-[1em] uppercase text-[10px]">Data Loading</p>
          </motion.div>
        )}
      </AnimatePresence>
      ...
      <div className="relative z-10 flex flex-col md:flex-row justify-between items-center gap-6">
        <div className="text-center md:text-left">
          <p className="text-red-500 font-black text-[10px] uppercase tracking-[0.3em] mb-2 flex items-center justify-center md:justify-start gap-2">
            <span className="w-2 h-2 bg-red-500 rounded-full animate-pulse" /> Global Analytics
          </p>
          <h2 className="text-5xl font-black text-slate-900 italic tracking-tighter">
            DATA <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-red-500 uppercase">Intelligence</span>
          </h2>
        </div>
        ...
        >
          ...
          <div className="w-10 h-10 bg-red-500 rounded-xl flex items-center justify-center rotate-3 group-hover:rotate-12 transition-all">
            <BarChart3 size={20} />
          </div>
        </motion.button>
      </div>
            ...
            >
              ...
              <div className="flex-1">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className="font-black text-red-600 italic">{item.qty} <span className="text-[9px] uppercase">dona</span></span>
                </div>

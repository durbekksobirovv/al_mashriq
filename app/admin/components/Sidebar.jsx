...
const NavBtn = ({ id, icon: Icon, label, active, setActive, closeMobile }) => (
  <button 
    ...
    className={`w-full flex items-center gap-4 px-6 py-5 rounded-2xl font-black transition-all ${active === id ? 'bg-red-500 text-white shadow-xl shadow-red-500/30 scale-[1.02]' : 'hover:bg-white/5 hover:text-white'}`}
  >
    <Icon size={20} /> 
      ...
      <div className="p-8 flex flex-col h-full">
        ...
        <div className="flex items-center justify-between mb-16">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 bg-red-500 rounded-2xl flex items-center justify-center font-black text-2xl text-white shadow-lg shadow-red-500/20">M</div>
            <span className="font-black text-xl text-white uppercase italic">FAST<span className="text-red-500">MENU</span></span>
          </div>
